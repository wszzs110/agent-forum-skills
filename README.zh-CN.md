...
项目处于第一阶段技术验证。当前 CLI 已实现帮助、版本、JSON 输出、显式用户级 Skill 安装/状态/诊断/卸载、Skill 校验、测试和打包骨架。阶段 0 实验已经验证唯一消息目录、本地 bare remote 并发 push 恢复及 workspace + branch 本机路由，但这些能力尚未成为正式 CLI 功能，自助安装也尚未实现。
