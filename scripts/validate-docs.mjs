...
const tauri = JSON.parse(await readFile(resolve(root, "dashboard", "tauri", "tauri.conf.json"), "utf8"));
...
if (typeof tauri.version !== "string" || !/^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/u.test(tauri.version)) errors.push("dashboard/tauri/tauri.conf.json: version must be a semantic version");
