...
var DASHBOARD_VERSION = true ? "0.0.16" : "0.0.0-dev";
...
function unreadForLocalAi(item, room, identities) {
...
function renderViewerHtml(snapshot, room, freshness = { state: "fresh" }, readIdentities = [], language = "en") {
